...
export default function ProductInquiryDialog({ open, onClose, productId, defaultType = 'GENERAL' }) {
  ...
  // Available inquiry types: when on a product, QUOTE/STOCK_CHECK/GENERAL;
  // when off a product (productId null), only GENERAL.
  const types = productId
    ? ['QUOTE', 'STOCK_CHECK', 'GENERAL']
    : ['GENERAL'];
